...
export const Footer = () => {
  ...
  return (
    <footer className='px-6 mt-20 py-24 border-t border-solid pointer-events-auto bg-[#0A0A0A] border-[#242424]'>
      <nav className='flex flex-wrap justify-around gap-5 mx-auto max-w-screen-2xl'>
        <div className='flex flex-col items-center justify-center w-full max-w-xs gap-5'>
          <div className='flex gap-3.5'>
            ...
            <span className='flex items-center text-sm text-[#A1A1A1]'>© 2024</span>
          </div>
          <div className='flex gap-3.5'>
            <Link
              href="www.linkedin.com/in/webdeveloper-next-mernstack"
              target='_blank'
              title="LindedIn of Kamil"
            >
              <svg
                data-testid="geist-icon"
                height="24"
            ...
            <Link
              href="https://github.com/kamilzafar"
              target='_blank'
              title="GitHub of Kamil"
            >
              <svg
                data-testid="geist-icon"
                height="24"
        ...
        <div className='w-full max-w-xs'>
          <h2 className='my-3 text-sm font-medium'>About Kamil</h2>
          <ul className='grid grid-cols-2'>
            <li className={liStyles}><Link href="www.linkedin.com/in/webdeveloper-next-mernstack" target='_blank' className={linkStyles}>LinkedIn</Link></li>
            <li className={liStyles}><Link href="https://github.com/kamilzafar" target='_blank' className={linkStyles}>GitHub</Link></li>
          </ul>
        </div>
      </nav>
    </footer>
