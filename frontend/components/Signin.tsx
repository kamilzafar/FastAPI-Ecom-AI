...
const Signin = () => {
    ...
    return (
        <section className="flex mx-auto items-center justify-center w-full pt-12 xs:h-80vh">
            <form
            ...
            >
                ...
                <button className="w-full bg-black border border-solid border-[#2E2E2E] py-1.5 mt-2.5 rounded
                    transition-all hover:bg-[#1F1F1F] hover:border-[#454545] text-13" type="submit"
                >
                    Signin
                </button>
                ...
                <Link href="/signup" className="text-sm transition duration-150 text-[#A1A1A1] ease hover:text-white">Don&apos;t have an account?</Link>
            </form>
        </section>
    );
}
